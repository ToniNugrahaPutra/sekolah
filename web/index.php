  ...
  ?>
      ...
      <div class="content-wrapper pt-0 mt-0"> 
        ...
        <table class="table" border="1px solid #111">
          ...
          <tbody>
            <!-- jadi ini relasi tabel yaitu join logikanya id ini diteruskan ke tabel yang sesuai dan mengambil nama sesuai id -->
      <?php 

      $query = "SELECT lokasi.id, provinsi.nama AS nama_provinsi, kabupaten.nama AS nama_kabupaten, kecamatan.nama AS nama_kecamatan, kelurahan.nama AS nama_kelurahan
      FROM lokasi
      JOIN provinsi ON lokasi.prov = provinsi.id_prov
      JOIN kabupaten ON lokasi.kab = kabupaten.id_kab
      JOIN kecamatan ON lokasi.kec = kecamatan.id_kec
      JOIN kelurahan ON lokasi.kel = kelurahan.id_kel
      ...
      $kab = $a['nama_kabupaten'];
      $kec = $a['nama_kecamatan'];
      $kel = $a['nama_kelurahan'];	
      /*if ($prov = $nama) {
          $nm_prov= "$nama";	
      } else {
          $hargae = "";
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card-content">
                <div class="card-body">
                    <div class="row">
                    <div class="col-sm-4 col-8 mx-auto pl-1 pr-1"> 
                            <div class="card text-center p-1 max-width" style="background: <?= $tombol ?>;  color: <?= $background ?>;">
                                <i class="fas fa-users fa-3x"></i>
                                <hr class="my-1">
                                <h3 class="counter font-large-4" style="color: <?= $background ?>;">120</h3>
                                <p class="text-uppercase text-bold-700">RPL,TKJ,MULTIMEDIA</p>
                            </div>
                        </div>
                    </div>
                </div>
