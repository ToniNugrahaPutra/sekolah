...
$(window).on("load", function () {
  ...
  var goalChart = new ApexCharts(
    document.querySelector("#goal-overview-chart-2"),
    goalChartoptions
  );
  ...
  var goalChart = new ApexCharts(
    document.querySelector("#goal-overview-chart-3"),
    goalChartoptions
  );
