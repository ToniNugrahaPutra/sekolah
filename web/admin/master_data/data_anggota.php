...
$b = mysqli_fetch_array(mysqli_query($koneksi, "SELECT * FROM tabel_anggota, tabel_kategori_anggota WHERE tabel_anggota.kategori = '$kategori'")); ?>
 <h2 class="content-header-title float-left mb-0">DATA</h2>
    <div class="breadcrumb-wrapper col-12">
      <ol class="breadcrumb">
           <li class="breadcrumb-item"><?php echo $b['nm_kat_anggota']; ?></li>                     
      </ol>
  </div>
      ...
      <div class="col-12">        
        <div class="card">
          <div class="card-content">
			...
			<a href="?menu=data_input" class="btn text-white" style="background:<?php echo $a['tombol'] ?>"><i class="feather icon-edit"></i> Tambah <?php echo $b['nm_kat_anggota']; ?></a>	
            <div class="card">
            <div class="divider">
...
<?php            
   error_reporting(0);
   $ketQuery = "SELECT * FROM tabel_anggota,tabel_alamat,tabel_data_anggota WHERE tabel_anggota.no_induk = tabel_alamat.no_induk AND tabel_anggota.no_induk = tabel_data_anggota.no_induk AND tabel_anggota.kategori=$kategori ORDER BY tabel_anggota.nama ASC";
   $executeSat = mysqli_query($koneksi, $ketQuery);
   while ($c=mysqli_fetch_array($executeSat)) {    
?>
                    
                       <tr>                    	
                        <td><?php echo $c['id_anggota']; ?>/<?php echo $c['no_induk']; ?></td>
                        <td>
