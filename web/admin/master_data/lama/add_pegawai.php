...
$rename_image = "$nama" . uniqid(rand()) . ".jpg";
...
$insert_1=mysqli_query($koneksi, "INSERT INTO tabel_anggota VALUES ('','pegawai','$no_induk','$angkatan','$nama','','','$kotalahir','$ttl','$jk','$jurusan','$asal')");
...
?><script language="JavaScript">document.location='../?menu=pegawai'</script>
