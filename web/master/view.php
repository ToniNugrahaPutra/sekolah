                ...
                <section class="card invoice-page">
                    <div id="invoice-template" class="card-body">
                        ...
                        <div id="invoice-company-details" class="row">
                            <div class="col-sm-3 col-4 text-center pt-1">
                                <div class="media pl-3 pt-1">
                                    <img src="admin/master_data/logo/<?php echo $logo;?>" class="img-fluid" width="100" />
                                </div>                                                                
                            </div>
                         ...
                         <hr style="color:<?php echo $headerfooter;?>">
                        <!--/ Invoice Company Details -->
                        ...
                        <div id="invoice-customer-details" class="row pt-2">
                            ...
                            <div class="col-sm-3 col-12 text-left">
                                <div class="media pt-1">
                                    <img src="admin/master_data/anggota/<?php echo $d['pas_foto'];?>" class="img-thumbnail" />
                                </div>
                        ...
                        <div id="invoice-footer" class="text-center">
                            <p>Bukti pendataan <?php echo $d['kategori'];?> yang diterbitkan oleh <?php echo $nm_dinas;?>
